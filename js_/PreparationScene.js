...
class PreparationScene extends Scene {
  ...
  update() {
    ...
    if (this.draggedShip && mouse.left) {
      ...
      const x = mouse.x - left - this.draggedOffsetX + 3;
      const y = mouse.y - top - this.draggedOffsetY + 3;
      ...
      this.draggedShip.x = null;
      this.draggedShip.y = null;
    }
    ...
    if (this.draggedShip && mouse.delta) {
      ...
      player.addaptiv(this.draggedShip);
    }
